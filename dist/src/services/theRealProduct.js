        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let [index, url] of urls.entries()) {
                    ...
                    yield page.waitForSelector('div.body-wrapper > div.container > main');
                    console.log("==========1========");
                    let count = 0;
                    /**
                    ...
                    yield page.waitForSelector('#user_email');
                    yield page.waitForSelector('#user_password');
                    yield page.type('#user_email', 'sauravm807@gmail.com', { delay: 100 });
                    yield page.type('#user_password', 'ABC@12345', { delay: 100 });
